...
var dashRoutes = [
    ...
    { path: BASEDIR + "/dashboard", name: "Dashboard", icon: "speedometer", badge: "", component: null },


    {
        path: "#", name: "Produk", icon: "energy", type: "dropdown", parentid: "products",
        child: [
            { path: BASEDIR + "/products", name: "Products" },
            { path: BASEDIR + "/add-product", name: "Add Product" },
            { path: BASEDIR + "/edit-product", name: "Edit Product" },
        ]
    },
    ...
    {
        path: "#", name: "Customer", icon: "people", type: "dropdown", parentid: "customers",
        child: [
    ...
    { path: BASEDIR + "/detail-customer", component: DetailCustomer, type: "child" },


    {
        path: "#", name: "Bisnis Unit", icon: "folder-alt", type: "dropdown", parentid: "bisnisunit",
        child: [
    ...
    { path: BASEDIR + "/bisnis-tambah-kategori", component: AddCategory, type: "child" },
    { path: BASEDIR + "/bisnis-produk", component: BisnisProduk, type: "child" },
    { path: BASEDIR + "/bisnis-tambah-produk", component: AddProduct, type: "child" },
    { path: BASEDIR + "/bisnis-edit-kategori", component: EditCategory, type: "child" },


    {
        path: "#", name: "Kategori", icon: "folder-alt", type: "dropdown", parentid: "kategori",
        child: [
    ...
    { path: BASEDIR + "/user-tambah-kategori", component: UserAddCategory, type: "child" },
    // { path: BASEDIR + "/bisnis-produk", component: BisnisProduk, type: "child" },
    { path: BASEDIR + "/user-tambah-produk", component: AddProduct, type: "child" },
    { path: BASEDIR + "/user-edit-kategori", component: EditCategory, type: "child" },


    {
        path: "#", name: "Seller", icon: "user", type: "dropdown", parentid: "vendors",
        child: [
    ...
    { path: BASEDIR + "/vendor-product", component: VendorProduct, type: "child" },



    {
        path: "#", name: "Invoice", icon: "wallet", type: "dropdown", parentid: "billing",
        child: [
    ...
    {
        path: "#", name: "Order", icon: "credit-card", type: "dropdown", parentid: "orders",
        child: [
    ...
    //     ]
    // },
    { path: BASEDIR + "/reports-sales", component: EcommerceReportsSales, type: "child" },
    { path: BASEDIR + "/reports-visitors", component: EcommerceReportsVisitors, type: "child" },
    { path: BASEDIR + "/reports-targets", component: EcommerceReportsTargets, type: "child" },
    ...
    {
        path: "#", name: "Quotation", icon: "tag", type: "dropdown", parentid: "tags",
        child: [
    ...
    { path: BASEDIR + "/settings", name: "Pengaturan", icon: "settings", component: null },
