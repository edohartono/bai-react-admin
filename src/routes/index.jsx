...
var indexRoutes = [
    ...
    { path: BASEDIR + "/", name: "Ecommerce Dashboard", component: EcommerceLayout },
    ...
    // { path: BASEDIR + "/", name: "Home", component: EcommerceLayout },
    // { path: "/", name: "Home", component: EcommerceLayout },
];
