    ...
    componentDidMount() {
        ...
        if (this.props.admintype === 'general') {
            ...
            this.setState({
                ...
                profileimg: IMGDIR + '/images/profile/profile-ecommerces.jpg'
            });
        } else if (this.props.admintype === 'freelance') {
            this.setState({
                profilename: 'Eric Nelson',
                profileimg: IMGDIR + '/images/profile/profile-freelances.jpg'
            });
            ...
            <Navbar expand="lg"
                ...
                <Container fluid>
                    <div className="navbar-wrapper">
                        ...
                        <Dropdown nav isOpen={this.state.messagesddOpen} toggle={(e) => this.messagesddToggle(e)} className="navbardd d-none">
                        ...
                        <Dropdown nav isOpen={this.state.notificationsddOpen} toggle={(e) => this.notificationsddToggle(e)} className="navbardd d-none">
                            <DropdownToggle caret nav>
                        ...
                        <form className="topbar-search-form d-none">
                        ...
                        <NavbarBrand href="/" className="d-none">{this.getBrand()}</NavbarBrand>
                    ...
                    <Collapse isOpen={this.state.isOpen} navbar className="navbar-right">
                        <Nav navbar>
                            <Dropdown nav isOpen={this.state.userddOpen} toggle={(e) => this.userddToggle(e)} className="userdd">
                                <DropdownToggle caret nav>
                                    <img src={this.state.profileimg} alt="react-logo" className="avatar-image d-none" /> <span>{this.state.profilename}</span>
                                </DropdownToggle>
                                <DropdownMenu right>
                                    ...
                                    <DropdownItem tag="a" className="" onClick={() => {
                                        localStorage.clear()
                                        window.location.reload()
                                    }} href=""><i className="i-lock"></i> Logout</DropdownItem>
                                </DropdownMenu>
                            </Dropdown>
                            <NavItem>
                                <div className="navbar-toggle chat-toggle d-none">
