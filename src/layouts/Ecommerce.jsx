...
import dashboardRoutes from 'routes/ecommerce.jsx';
import { topbarStyle, menuStyle, menuType, topbarType, navWidth, chatWidth, chatType } from 'variables/settings/ecommerce.jsx';

//var ps;

class EcommerceLayout extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            menuColor: menuStyle,
    ...
    render() {
        ...
        return (
            <div className="wrapper" ref="themeWrapper" data-menu={this.state.menuColor} data-topbar={this.state.topbarColor} data-menutype={this.state.menuType} data-topbartype={this.state.topbarType}>
                ...
                <Header {...this.props} navtype={navWidth} admintype={'ecommerce'} />
                <Sidebar {...this.props} routes={dashboardRoutes} admintype={'ecommerce'} />
