                                                                ...
                                                                <div className="card mb-3">
                                                                    <div className="card-body">
                                                                        ...
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-sm-9 text-secondary">
                                                                                {customer.gender == 'L' ? 'Laki-laki' :
                                                                                    customer.gender == 'P' ? 'Perempuan' : <i>Jenis kelamin belum diisi</i>
                                                                                }
                                                                            </div>
                                                                        </div>
                                                                        <hr />
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-sm-9 text-secondary">
                                                                                {customer.birth_date ? moment(customer.birth_date).format('DD MMMM YYYY') : <i>Tanggal lahir belum diisi</i>
                                                                                }
                                                                            </div>
                                                                        </div>
                                                                        <hr />
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-sm-9 text-secondary">
                                                                                {moment(customer.created_at).format('DD MMMM YYYY')}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
