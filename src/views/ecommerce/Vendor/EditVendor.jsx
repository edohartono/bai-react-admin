...
export class EditVendor extends Component {
    ...
    async edit() {
        ...
        edited.id = this.state.detail.id
        let submit = await API.patch('sellers', edited)
        if (submit.success) {
            Swal.fire('', 'Berhasil memperbarui data penjual', 'success')
        }

        else {
            Swal.fire('', 'Gagal memperbarui data penjual', 'error')
    ...
    async getData(id) {
        ...
        if (!get.success) {
            ...
            this.setState({ detail: get.result.data[0] })
            return false
        }
    }
    ...
    async statusUser(id, status) {
        ...
        if (status == 'B') {
            Swal.fire({
                text: 'Apakah anda yakin ingin banned penjual?',
                icon: 'warning',
                            ...
                            <div className="col-12">
                                <section className="box ">
                                    <header className="panel_header">
                                        <h2 className="title float-left">Edit Penjual</h2>
                                                                ...
                                                                <div className="card">
                                                                    <div className="card-body">
                                                                        <div className="d-flex flex-column align-items-center text-center">
                                                                            <img src={imageURL + detail.display_picture} alt="Admin" className="rounded-circle" width={150} />
                                                                            <div className="mt-3">
                                                                                <h4>{detail.name}</h4>
                                                                                {
                                                                                    detail.active == 'Y' &&
                                                                                    <>
                                                                                        ...
                                                                                        <Button
                                                                                            ...
                                                                                            onClick={() => this.statusUser(detail.id, 'B')}
                                                                                ...
                                                                                }
                                                                                {
                                                                                    ...
                                                                                    <>
                                                                                        ...
                                                                                        <Button
                                                                                            ...
                                                                                            size="sm"
                                                                                            disabled={this.state.submit}
                                                                                            onClick={() => this.statusUser(detail.id, 'Y')}
                                                                                ...
                                                                                {/* <Button
                                                                                    color="warning"
                                                                                    size="sm"
                                                                                    onClick={() => window.location = `/edit-detail?${detail.id}`}
                                                                                >Edit User</Button> */}
                                                            ...
                                                            <div className="col-md-8">
                                                                <form onSubmit={e => {
                                                                    ...
                                                                    <div className="form-group row">
                                                                        ...
                                                                        <div className="col-8">
                                                                            <input id="name" name="name" placeholder="Nama" type="text" className="form-control" required="required" onChange={(e) => this.setInputValue(e.target.name, e.target.value)} value={detail.name} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <label htmlFor="email" className="col-4 col-form-label">Email</label>
                                                                        <div className="col-8">
                                                                            <input id="email" name="email" placeholder="Email" type="text" className="form-control" required="required" disabled onChange={(e) => this.setInputValue(e.target.name, e.target.value)} value={detail.email} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <label htmlFor="phone" className="col-4 col-form-label">No HP</label>
                                                                        <div className="col-8">
                                                                            <input id="phone" name="phone" placeholder="No HP" type="text" className="form-control" required="required" onChange={(e) => this.setInputValue(e.target.name, e.target.value)} value={detail.phone} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <label className="col-4 col-form-label" htmlFor="gender">Tipe Perusahaan</label>
                                                                        <div className="col-8">
                                                                            <select id="company_type" name="company_type" className="custom-select" onChange={(e) => this.setInputValue(e.target.name, e.target.value)} value={detail.company_type}>
                                                                    ...
                                                                    <div className="form-group row">
                                                                        <label className="col-4 col-form-label" htmlFor="company">Perusahaan</label>
                                                                        <div className="col-8">
                                                                            <input id="company" name="company" placeholder="Perusahaan" type="text" className="form-control" required="required" onChange={(e) => this.setInputValue(e.target.name, e.target.value)} value={detail.company} />

                                                                        </div>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <label className="col-4 col-form-label" htmlFor="company_profile">Profil Perusahaan</label>
                                                                        <div className="col-8">
                                                                            <input id="company_profile" name="company_profile" placeholder="Profil Perusahaan" type="text" className="form-control" required="required" onChange={(e) => this.setInputValue(e.target.name, e.target.value)} value={detail.company_profile} />
                                                                    ...
                                                                    <div className="form-group row">
                                                                        ...
                                                                        <div className="col-8">
                                                                            <input id="created_at" name="created_at" type="text" className="form-control" disabled value={moment(detail.created_at).format('DD MMMM YYYY')} />
                                                                        </div>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <div className="offset-4 col-8">
                                                                            <button name="submit" type="submit" className="btn btn-primary">Simpan</button>
                                                                        </div>
                                                                    </div>
                                                                </form>
